...
And this codebase is a product of solving these problems.

<br>

## A Walk Through of DeepCodebase
...
<img align="right" src="./docs/_static/imgs/deepcodebase_overview.png" width=360 />
...
- [**Netron:**](https://github.com/lutzroeder/netron) the tool to visualize the neural network architectures.
- [**Gradio:**](https://gradio.app/) the tool to demo your machine learning model with a friendly web interface.
...
- [DeepCodebase](#deepcodebase)
  - [Introduction](#introduction)
  - [A Walk Through of DeepCodebase](#a-walk-through-of-deepcodebase)
    - [Key Ideas](#key-ideas)
    ...
    - [Write a README for your released project*](#write-a-readme-for-your-released-project)
...
### Write a README for your released project*

A good README is able to help users to understand your project quickly. We provide a template at [README_TEMPLATE.md](./README_TEMPLATE.md).
